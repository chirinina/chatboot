...
document.getElementById('home-btn').addEventListener('mouseenter', function () {
    ...
    "Mi Nota": `Para ver tus notas puedes ingresar a moodle dirijirte al apartado de calificaciones o directamente consultar<br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
    ...
    "Plazo para mi tarea": `Si el tiempo limite a expirado de tu entraga de tarea puedes contactarte con:<button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59163750724?text=Hola,%20por%20favor%20solicito%20plazo%20para%20mi%20entrega%20de%20mi%20tarea.', '_blank')">Asistente Academicos:</button>`,
    ...
    "": ".",
    "Ver Requisitos": `Para que puedas ver los requisitos importantes para tu admicion puedes dar clik en el siguiente boton:<br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
    ...
    button1 = createButton("Diplomado", "");
    button2 = createButton("Maestrias", "");

...
document.getElementById('home-btn').addEventListener('mouseenter', function () {
    ...
    const responses = {
    "Uso general de Moodle": `Si es la primera experiencia que esta ingresando al moodle puede pedir ayuad al area TI:<br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59171014010?text=Buenas Ing.,%20quisiera que me%20pueda%20mi%20colaborar mi Nombre es:.', '_blank')">Pedir ayuda</button>`,
    "Área Académica": `El área académica se enacarga de planes de estudio, notas, exámenes puedes Hablar con el encargad@. cualquier consulta que tengas puedes contactarte:<button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59173360695?text=Hola,%20nesecito%20de%20su%20conlaboracion mi Nombre es:.', '_blank')">Contactarme</button>`,
    "Area TI": "En el área de Tecnología de la Información gestiona la infraestructura, el soporte técnico y los servicios tecnológicos para garantizar el funcionamiento eficiente de la organización",
    "Otros": `Para más referencia puedes consultar al asistente virtual.<button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2025/01/20/18/20250120181142-BKEDTJ2R.json', 'LumiBot', 'width=400,height=580');">Hablar con LumiBot + IA</button>`,
    "Area Contable": `En el área contable puedes consultar tu estado de cuenta, pagos pendientes, facturas y otros trámites relacionados con las finanzas.<br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; margin: 5px; border-radius:5px;" onclick="window.open('https://participantes.esam.edu.bo/login/?callbackUrl=https%3A%2F%2Fparticipantes.esam.edu.bo%2F', '_blank')">Ver mi pago</button><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59171863154?text=Como esta,%20hablo con el&20area%20contable?%20mi Nombre es:', '_blank')">Contactarme</button>`,
    "Reportar problema": `Tienes problemas relacionados con el acceso al sistema o su funcionamiento puede ayudarte: <button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2025/01/20/18/20250120181142-BKEDTJ2R.json', '_blank', 'width=360,height=500,scrollbars=yes')">Asistente virtual +IA</button>o puedes contactarte con el responsable de TI<br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59163365875?text=Buenas Ing,%20quisiera que me%20pueda%20colaborar mi nombre es:', '_blank')">Hablar con el soporte</button>`,
    "Habla con LumiBot +IA": `Puede que te pueda ayudar el asistente virtual<button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2025/01/20/18/20250120181142-BKEDTJ2R.json', '_blank', 'width=360,height=500,scrollbars=yes')">Asistente virtual +IA</button>`,
    ...
    "Planes de estudio": `Los planes de estudio son los documentos que detallan las materias que debes cursar según tu Fomacion Profesional. Consulta los planes específicos de tu Fomacion<button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59163750724?text=Hola,%20me%20puede%20proporcionar%20los planes de estudio.', '_blank')">Maestria</button>`,
    "Mi Nota": `Para verificar tus notas puedes ingresar ala pltaforma y dirijirte al apartado de calificaciones o directamente consultar<br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://moodle.esam.edu.bo/grade/report/overview/index.php', '_blank')">Ingresar al moodle</button><br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59173360695?text=Hola,%20me puede%20proporcionar%20mi nota%20mi Nombre es:.', '_blank')">Consultar</button>`,
    "Hablar con LumiBot +IA": "Hablando con IA..",
    "Planes de estudio": `Claro, puedo ayudarte Si necesitas más información o contactar directamente con ellos, puedes hacer clic en el siguiente botón para comunicarte con:<br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59173355489?text=Hola,%20me%20gustaria%20obtener%20mas%20informacion%20¿Podrían%20ayudarme,%20por%20favor?.', '_blank')">Contactar</button>`,
    "Solicitar certificado": `Para solicitar tu certificado, puedes comunicarte con la persona responsable:.<button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59174443230?text=Hola,%20quisiera%20solicitar%20mi%20certificado mi Nombre es:.', '_blank')">Contactarme</button>`,
    "Ver mis calificaciones": `Ingrensando al moodle en el apartado de calificaciones puedes ver.<button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://moodle.esam.edu.bo/grade/report/overview/index.php', '_blank')">Calificaciones</button>`,
    "Estado del título": `Para obtener detalles sobre el estado de tu título, te recomendamos contactar directamente con la administración al siguiente link con Lic Fany:.<button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59174443230?text=Hola,%20quisiera%20amablemente%20solicitar%20información%20sobre%20el%20proceso%20y%20estado%20de%20mi%20título.%20Agradezco%20mucho%20su%20atención%20y%20quedo%20a%20disposición%20para%20cualquier%20detalle%20adicional.%20Muchas%20gracias.', '_blank')">Contactarme</button>`,
    "Ver estado de cuenta": `Para ver tus pagos puedes contactarte directamente con la encargada de Finanzas <button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59171863154?text=Hola,%20me%20puede verificar%20el%20estado%20de pago mi Nombre es:.', '_blank')">Contactarme</button><br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://participantes.esam.edu.bo/login/?callbackUrl=https%3A%2F%2Fparticipantes.esam.edu.bo%2F', '_blank')">Ver en el moodle</button>`,
    "Plazo para mi tarea": `Si el tiempo limite a expirado de tu entraga de tarea directamente contactate con el respondable con una previa justificacion:<br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59163750724?text=Hola,%20por%20favor%20solicito%20plazo%20para%20mi%20entrega%20de%20mi%20tarea.', '_blank')">Contactar</button>`,
    "Como ingresar": `Tenemos tutorial de como ingresar al moodle<br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://youtu.be/2hiXzkzpLcs', '_blank', 'width=490,height=370', '_blank')">Ver video</button>`,
    "Como ver mi calificacion": `Tenemos tutorial de como visualizar la calificacion<br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://youtu.be/jtda5Z9kXXM', '_blank', 'width=490,height=370', '_blank')">Ver ahora</button>`,
    
     "Pagar": `Puedes pagar mediante QR y enviar el comprobante o contactarte directamente con el area:<br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" <button id="qrBtn" onclick="if(window.contadorQR===undefined)window.contadorQR=0;if(window.contadorQR<2){let v=window.open('https://i.ibb.co/yn62nyp/QR-gerenado-por-esam.jpg','_blank','width=500,height=600');window.contadorQR++;setTimeout(()=>{if(v&&!v.closed)v.close();},15000);}if(window.contadorQR>=2){setTimeout(()=>document.getElementById('qrBtn').style.display='none',2000);}">Generar QR</button><br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59171863154?text=Hola,%20he%20realizado%20mi%20pago por QR mi nombre es:', '_blank')">Enviar Comprobante</button><br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59171863154?text=Hola,%20quiero%20realizar%20el%20pago mi Nombre es:', '_blank')">Contactarme</button>`,
    "Acceder ala plataforma": `Puedo ayudarte`,
    "Solicitar mi acceso": `Para solicitar acceso, comuníquese con el área de TI proporcionando tu Nombre y CI.<button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59174681419?text=Hola,%20me%20puede%20proporcionar%20mis%20accesos%20plataforma%20por%20favor%20mi%20Nombre y CI%20es:', '_blank')">Solicitar</button>`,
    "": ".",
    "Ver Requisitos": `Para que puedas ver los requisitos importantes para tu formacion puedes dar clik en el siguiente boton:<br><br><button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" <button onclick="window.open('https://i.ibb.co/CHttKqp/Reguisitos.jpg', '_blank', 'width=400,height=600');">Ver requisitos</button>`,
    "Desbloqueo de la Plataforma": `Si ya pagaste tus mensualidades y no puedes acceder a la plataforma, ponte en contacto con area de finanzas. Haz clic en el siguiente botón para enviarnos un mensaje <button style="border:none; background:#084e8b; color:#ffffff; cursor:pointer; padding:5px 10px; border-radius:5px; transition: 0.3s;" 
     onmouseover="this.style.background='#ffffff'; this.style.color='#084e8b';" 
     onmouseout="this.style.background='#084e8b'; this.style.color='#ffffff';" onclick="window.open('https://wa.me/59164463023?text=Hola,%20me%20puede%20reactivar%20en%20la%20plataforma%20por%20favor%20mi%20Nombre%20es:', '_blank')">Contactarme</button>`
    };
    ...
    button2 = createButton("¿Como Ingresar al moodle?", "Como ingresar");
    button3 = createButton("Acceder ala plataforma", "Acceder ala plataforma");
    ...
    button1 = createButton("Habla con LumiBot +IA", "Habla con LumiBot +IA");
    button2 = createButton("Solicitar mi acceso", "Solicitar mi acceso");
    ...
    button1 = createButton("Diplomado", "ver");
    button2 = createButton("Maestrias", "ver");
    ...
    button4 = createButton("Otros", "Otros");
      ...
      button3.onclick = function() {
        window.open("https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2025/01/20/18/20250120181142-BKEDTJ2R.json", "Consultar", "width=400, height=500");
      };
  ...
  } else if (title === "Acceder ala plataforma") {
    button1 = createButton("Consultar asistente +IA", "");
    button1.onclick = function() {
       window.open("https://cdn.botpress.cloud/webchat/v2.2/shareable.html?configUrl=https://files.bpcontent.cloud/2025/01/20/18/20250120181142-BKEDTJ2R.json", "Consultar", "width=400, height=500");
    };
    button2 = createButton("Ingresar al moodle", "https://moodle.esam.edu.bo/login/index.php");
    button3 = createButton("Solicitar acceso", "https://wa.me/59163365875?text=Hola,%20me%20puedes%20proporcionar%20mis%20datos%20de%20acceso%20al%20Moodle?%20Mi%20Nombre%20es:.");
    button4 = createButton("Reportar problema", "Reportar problema");
    }else if (title === "Examenes") {
    button1 = createButton("Ingresar al moodle", "https://moodle.esam.edu.bo/login/index.php");
    button2 = createButton("Ver cursos disponibles", "https://esam.edu.bo/");
    button3 = createButton("Contactarme", "https://wa.link/u1xtx7");
    button4 = createButton("Pedir Plazo", "Pedir Plazo");
    } else if (title === "Ver mis calificaciones") {
    button1 = createButton("Ingresar al moodle", "https://moodle.esam.edu.bo/login/index.php");
    button2 = createButton("Ver mi cursos", "https://moodle.esam.edu.bo/my/courses.php");
    button3 = createButton("Ver video", "Como ver mi calificacion");
    button4 = createButton("Solicitar acceso", "No puedo generar credenciales por razones de seguridad. Para obtener acceso, comuníquese con el área de TI al 74681419");
    } else {
